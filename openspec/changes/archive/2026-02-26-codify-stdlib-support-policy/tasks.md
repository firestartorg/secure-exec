...
- [x] 1.1 Remove the `@hono/node-server` entry from the "Third-party stubs" section of `node-compatability.mdx`
...
- [x] 2.1 Add a "Support Tiers" legend section at the top of `node-compatability.mdx` defining the five tiers (Bridge, Polyfill, Stub, Deferred, Unsupported)
