...
import type { VirtualFileSystem, VirtualStat, VirtualDirEntry } from "@firestartorg/secure-exec-core";
import { KernelError, O_CREAT, O_EXCL, O_TRUNC } from "@firestartorg/secure-exec-core";
