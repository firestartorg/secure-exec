...
- `wasmvm/test/driver.test.ts:123` — "createWasmVmRuntime returns a RuntimeDriver"
- `wasmvm/test/driver.test.ts:235` — "spawn returns DriverProcess with correct interface"
...
- `wasmvm/test/driver.test.ts:213, 272`
